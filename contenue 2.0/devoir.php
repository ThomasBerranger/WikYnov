    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="#">Devoir <span class="sr-only">(current)</span></a></li>
...
<div class="container">
    <div class="row">
        <div class="col-sm-2 col-xs-4"><h1><i class="fa fa-file" aria-hidden="true"></i></h1> <p class="nomauteur">Jean Jaque</p> Devoir de math</div>
        <div class="col-sm-2 col-xs-4"><h1><i class="fa fa-file" aria-hidden="true"></i></h1> <p class="nomauteur">Jean Jaque</p> glouglouglou</div>
        <div class="col-sm-2 col-xs-4"><h1><i class="fa fa-file" aria-hidden="true"></i></h1> <p class="nomauteur">Jean Jaque</p> glouglouglou</div>
        <div class="col-sm-2 col-xs-4"><h1><i class="fa fa-file" aria-hidden="true"></i></h1> <p class="nomauteur">Jean Jaque</p> devoir de chinois</div>
        <div class="col-sm-2 col-xs-4"><h1><i class="fa fa-file" aria-hidden="true"></i></h1> <p class="nomauteur">Jean Jaque</p> glouglouglou</div>
        <div class="col-sm-2 col-xs-4"><h1><i class="fa fa-file" aria-hidden="true"></i></h1> <p class="nomauteur">Jean Jaque</p> glouglouglou</div>
        ...
        <div class="col-sm-2 col-xs-4"><h1><i class="fa fa-file" aria-hidden="true"></i></h1> <p class="nomauteur">Jean Jaque</p> ttttt</div>
        <div class="col-sm-2 col-xs-4"><h1><i class="fa fa-file" aria-hidden="true"></i></h1> <p class="nomauteur">Jean Jaque</p> Mon devoir a été mangé par le chien de mes voisins</div>
        <div class="col-sm-2 col-xs-4"><h1><i class="fa fa-file" aria-hidden="true"></i></h1> <p class="nomauteur">Jean Jaque</p> glouglouglou</div>
        <div class="col-sm-2 col-xs-4"><h1><i class="fa fa-file" aria-hidden="true"></i></h1> <p class="nomauteur">Jean Jaque</p> glouglouglou</div>
    </div>
</div>
