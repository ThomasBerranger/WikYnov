    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="#">Autres Thématiques <span class="sr-only">(current)</span></a></li>
...
<h1 class="h1">Page des nouvelles thématiques</h1>
<br><br><br>
<div class="container">
    <div class="row">
        <a href="multimedia.php" class="h2"><i class="fa fa-play-circle" aria-hidden="true"></i> Multimédia</a><br><br>
        <a href="devoir.php" class="h2"><i class="fa fa-file" aria-hidden="true"></i> Devoir</a><br><br>
        <a href="#" class="h2"><i class="fa fa-cutlery" aria-hidden="true"></i> Carotte</a><br><br>
        <a href="#" class="h2"><i class="fa fa-coffee" aria-hidden="true"></i> Café</a><br><br>
    </div>
</div>
