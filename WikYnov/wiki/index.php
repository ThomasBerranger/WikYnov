...
<div class="row">
    <div class="col-md-6">
        <form action="" class="formulaire" method="post">
            <h1>Inscription</h1>
            <br><input class="formu" type="text" name="identifiant" value="<?php if(isset($_POST['identifiant'])) { echo htmlentities($_POST['identifiant']);}?>" id="identifiant" placeholder="Prénom" required="required" style="text-align:center"/><br>
            ...
            <input class="formu" type="email" name="mail" value="<?php if(isset($_POST['mail'])) { echo htmlentities($_POST['mail']);}?>" id="mail" placeholder="Email" required="required" style="text-align:center"/><br>
        ...
        if($identifiantlength <= 50 )
        {
            ...
            if(preg_match($syntaxe, $mail))
            {
                if($mdp == $mdp2)
                {
                    ...
                    header("Location: actualites.php?id=".$_SESSION['id']);
    ...
    <div class="col-md-6">
        <form class="formulaire" action="" method="post">
            <h1>Connexion</h1>
            <br><input class="formu" type="text" name="identifiantConnexion" value="<?php if(isset($_POST['identifiantConnexion'])) { echo htmlentities($_POST['identifiantConnexion']);}?>" placeholder="Identifiant" required="required" style="text-align: center"/><br>
